      ...
      .catch(() => this.http.get(url)
        ...
        .then((response: Response) => {
          ...
          if (repos && repos.length) {
            GithubsearchService.cache[userid].repos = repos.map((repo: any) => {
      ...
      .catch(() => this.http.get(url)
        ...
        .then((response: Response) => {
          ...
          if (followers && followers.length) {
            GithubsearchService.cache[userid].followers = followers.map((user: any) => {
      ...
      .catch(() => this.http.get(url)
        ...
        .then((response: Response) => {
          ...
          if (following && following.length) {
            GithubsearchService.cache[userid].following = following.map((user: any) => {
              return {login: user.login};
            });
          }
          return following;
